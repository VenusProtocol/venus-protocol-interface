...
export class WalletConnectConnector extends AbstractConnector {
  ...
  constructor(params: WalletConnectConnectorArguments) {
    super({ supportedChainIds: getSupportedChains(params) });
    this.config = params;
  ...
  public async activate(): Promise<ConnectorUpdate> {
    ...
    const account = await new Promise<string>((resolve, reject) => {
      ...
      // Workaround to bubble up the error when user rejects the connection
