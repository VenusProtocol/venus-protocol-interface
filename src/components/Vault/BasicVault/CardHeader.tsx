      ...
      <Row className="header">
        <Col className="col-item" lg={{ span: 3 }} md={{ span: 6 }} xs={{ span: 12 }}>
          ...
          <div className="content">
            <Icon size="16px" name={stakedToken.toLowerCase() as IconName} />
        ...
        <Col className="col-item" lg={{ span: 3 }} md={{ span: 6 }} xs={{ span: 12 }}>
          ...
          <div className="content">
            <Icon size="16px" name={rewardToken.toLowerCase() as IconName} />
        ...
        >
          <Icon className="expand-icon" size="16px" name="arrowDown" />
        </Col>
      </Row>
    </div>
  );
