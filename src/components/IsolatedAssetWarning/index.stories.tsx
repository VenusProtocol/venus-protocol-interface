...
export const Borrow = () => (
  <IsolatedAssetWarningUi pool={poolData[0]} assetId={poolData[0].assets[0].id} type="borrow" />
);

export const Supply = () => (
  <IsolatedAssetWarningUi pool={poolData[0]} assetId={poolData[0].assets[0].id} type="supply" />
);
