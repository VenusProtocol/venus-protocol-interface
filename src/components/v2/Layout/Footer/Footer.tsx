...
export const Footer: React.FC<IFooterProps> = ({ currentBlockNumber }) => {
  ...
  return (
    <div css={styles.Container}>
      ...
      <div css={styles.SocialMediaLinks}>
        <a css={styles.SocialMediaLink} href={VENUS_MEDIUM_URL} target="_blank" rel="noreferrer">
          <Icon name="medium" color={styles.theme.palette.text.primary} size="12px" />
        </a>

        <a css={styles.SocialMediaLink} href={VENUS_DISCORD_URL} target="_blank" rel="noreferrer">
          <Icon name="discord" color={styles.theme.palette.text.primary} size="12px" />
        </a>

        <a css={styles.SocialMediaLink} href={VENUS_TWITTER_URL} target="_blank" rel="noreferrer">
          <Icon name="twitter" color={styles.theme.palette.text.primary} size="12px" />
        </a>

        <a css={styles.SocialMediaLink} href={VENUS_GITHUB_URL} target="_blank" rel="noreferrer">
