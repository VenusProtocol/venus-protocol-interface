...
describe('hooks/useSupplyWithdrawModal/Withdraw', () => {
  ...
  it('submit is disabled with no amount', async () => {
    ...
    await waitFor(() =>
      getByText(en.operationModal.withdraw.submitButton.enterValidAmountWithdrawLabel),
    );

    const disabledButtonText = getByText(
      en.operationModal.withdraw.submitButton.enterValidAmountWithdrawLabel,
    );
  ...
  it('redeem is called when full amount is withdrawn', async () => {
    ...
    const maxButton = await waitFor(() => getByText(en.operationModal.withdraw.max.toUpperCase()));
    act(() => {
    ...
    await waitFor(() =>
      expect(submitButton).toHaveTextContent(en.operationModal.withdraw.submitButton.enabledLabel),
    );
