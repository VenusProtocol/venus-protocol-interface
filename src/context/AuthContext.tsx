...
export const AuthProvider: React.FC = ({ children }) => {
  ...
  const handleOpenAuthModal = (connector: Connector) => {
    login(connector);
    closeAuthModal();
  };
    ...
    >
      ...
      >
        ...
        <ModalContent className="flex flex-column align-center just-center">
          <img className="close-btn pointer" src={closeImg} alt="close" onClick={closeAuthModal} />
          {!account ? (
            <>
              ...
              <div className="connect-wallet-content">
                ...
                <div
                  ...
                  onClick={() => handleOpenAuthModal(Connector.MetaMask)}
                >
                  <div className="flex align-center">
                ...
                <div
                  className="flex align-center just-between metamask-connect-btn"
                  onClick={() => handleOpenAuthModal(Connector.WalletConnect)}
                >
                  <div className="flex align-center">
                ...
                <div
                  className="flex align-center just-between metamask-connect-btn"
                  onClick={() => handleOpenAuthModal(Connector.BSC)}
                >
                  <div className="flex align-center">
            ...
            <div className="wallet-section">
              ...
              <div className="wallet-footer">
                <PrimaryButton className="logout-btn" onClick={logOut}>
                  Logout
                </PrimaryButton>
              </div>
            </div>
