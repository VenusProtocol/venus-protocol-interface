...
export class IsolatedPoolComptroller__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IsolatedPoolComptroller {
    return new Contract(address, _abi, signerOrProvider) as IsolatedPoolComptroller;
  }
}
