...
export interface Vai extends BaseContract {
  ...
  functions: {
    ...
    deny(guy: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
    ...
    rely(guy: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    deny(guy: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
    ...
    rely(guy: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    deny(guy: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
    ...
    rely(guy: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
