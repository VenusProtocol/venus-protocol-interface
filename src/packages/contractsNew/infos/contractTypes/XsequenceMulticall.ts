...
export declare namespace IModuleCalls {
  ...
  export type TransactionStructOutput = [boolean, boolean, BigNumber, string, BigNumber, string] & {
    delegateCall: boolean;
    revertOnError: boolean;
    gasLimit: BigNumber;
    target: string;
...
export interface XsequenceMulticallInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'callBalanceOf', values: [string]): string;
  encodeFunctionData(functionFragment: 'callBlockNumber', values?: undefined): string;
  encodeFunctionData(functionFragment: 'callBlockhash', values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: 'callCodeHash', values: [string]): string;
  encodeFunctionData(functionFragment: 'callCodeSize', values: [string]): string;
  ...
  encodeFunctionData(functionFragment: 'knownImageHashes', values: [string]): string;
  encodeFunctionData(functionFragment: 'lastImageHashUpdate', values: [BytesLike]): string;
  encodeFunctionData(functionFragment: 'lastSignerUpdate', values: [string]): string;
  encodeFunctionData(functionFragment: 'lastWalletUpdate', values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'requireMinNonce', values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'requireNonExpired', values: [BigNumberish]): string;
...
export type RequiredSignerEvent = TypedEvent<[string, string], RequiredSignerEventObject>;
...
export interface XsequenceMulticall extends BaseContract {
  ...
  functions: {
    ...
    callChainId(overrides?: CallOverrides): Promise<[BigNumber] & { id: BigNumber }>;

    callCode(_addr: string, overrides?: CallOverrides): Promise<[string] & { code: string }>;
    ...
    lastImageHashUpdate(arg0: BytesLike, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    requireNonExpired(_expiration: BigNumberish, overrides?: CallOverrides): Promise<[void]>;
  };
  ...
  requireMinNonce(_wallet: string, _nonce: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  callStatic: {
    ...
    multiCall(
      _txs: IModuleCalls.TransactionStruct[],
      overrides?: CallOverrides,
    ): Promise<[boolean[], string[]] & { _successes: boolean[]; _results: string[] }>;
  ...
  filters: {
    ...
    RequiredSigner(_wallet?: string | null, _signer?: string | null): RequiredSignerEventFilter;
  };
  ...
  estimateGas: {
    ...
    callBlockhash(_i: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    knownImageHashes(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    requireNonExpired(_expiration: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  };

  populateTransaction: {
    callBalanceOf(_addr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    callBlockNumber(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    callBlockhash(_i: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    callChainId(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    callCode(_addr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    callCodeHash(_addr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    callCodeSize(_addr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    knownImageHashes(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    lastImageHashUpdate(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    lastSignerUpdate(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    lastWalletUpdate(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
