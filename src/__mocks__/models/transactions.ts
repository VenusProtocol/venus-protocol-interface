...
const transactions: Transaction[] = [
  {
    ...
    category: 'vtoken',
    createdAt: new Date('2022-05-26T07:28:57.000Z'),
    event: 'Transfer',
  ...
  {
    amount: new BigNumber(6.53799e-8),
    blockNumber: 19636720,
    category: 'vtoken',
    createdAt: new Date('2022-05-26T07:27:42.000Z'),
    event: 'Transfer',
  ...
  {
    amount: new BigNumber(1.4696e-10),
    blockNumber: 19632326,
    category: 'vtoken',
    createdAt: new Date('2022-05-26T03:48:02.000Z'),
    event: 'Transfer',
  ...
  {
    amount: new BigNumber(1719.1),
    blockNumber: 19625976,
    category: 'vtoken',
    createdAt: new Date('2022-05-25T22:30:33.000Z'),
    event: 'Mint',
  ...
  },
  {
    ...
    category: 'vtoken',
    createdAt: new Date('2022-05-25T13:11:21.000Z'),
    event: 'Redeem',
  ...
  {
    amount: new BigNumber(2.94228e-12),
    blockNumber: 19614805,
    category: 'vtoken',
    createdAt: new Date('2022-05-25T13:10:22.000Z'),
    event: 'Transfer',
    from: '0x2E7222e51c0f6e98610A1543Aa3836E092CDe62c',
    id: 11164,
    timestamp: null,
  ...
  },
  {
    ...
    category: 'vtoken',
    createdAt: new Date('2022-05-25T13:06:11.000Z'),
    event: 'Redeem',
    from: '0xa60dF6af57fb55c62511cA96eD6dA0AfE977436b',
    id: 11163,
    timestamp: null,
  ...
  },
  {
    ...
    category: 'vtoken',
    createdAt: new Date('2022-05-25T13:05:24.000Z'),
    event: 'Mint',
    from: '0xa60dF6af57fb55c62511cA96eD6dA0AfE977436b',
    id: 11162,
    timestamp: null,
  ...
  },
  {
    ...
    category: 'vtoken',
    createdAt: new Date('2022-05-25T11:15:03.000Z'),
    event: 'Mint',
  ...
  {
    amount: new BigNumber(4.24332e-11),
    blockNumber: 19606971,
    category: 'vtoken',
    createdAt: new Date('2022-05-25T06:38:32.000Z'),
    event: 'Borrow',
  ...
  },
  {
    ...
    category: 'vtoken',
    createdAt: new Date('2022-05-25T06:37:03.000Z'),
    event: 'Mint',
    from: '0xB4A5A75A3cA76CF0939EF4A1fFb5DF3432F80e96',
    id: 11159,
    timestamp: null,
  ...
  {
    amount: new BigNumber(3.93566e-7),
    blockNumber: 19605600,
    category: 'vtoken',
    createdAt: new Date('2022-05-25T05:30:03.000Z'),
    event: 'Transfer',
    from: '0x08e0A5575De71037aE36AbfAfb516595fE68e5e4',
    id: 11158,
    timestamp: null,
  ...
  },
  {
    ...
    category: 'vtoken',
    createdAt: new Date('2022-05-25T05:06:27.000Z'),
    event: 'Mint',
  ...
  {
    amount: new BigNumber(9.43277e-9),
    blockNumber: 19589102,
    category: 'vtoken',
    createdAt: new Date('2022-05-24T15:33:42.000Z'),
    event: 'Transfer',
  ...
  {
    amount: new BigNumber(0.0000012189),
    blockNumber: 19589089,
    category: 'vtoken',
    createdAt: new Date('2022-05-24T15:33:03.000Z'),
    event: 'Transfer',
  ...
  },
  {
    ...
    category: 'vtoken',
    createdAt: new Date('2022-05-24T15:30:52.000Z'),
    event: 'Mint',
  ...
  {
    amount: new BigNumber(4.20132e-10),
    blockNumber: 19588967,
    category: 'vtoken',
    createdAt: new Date('2022-05-24T15:27:02.000Z'),
    event: 'Transfer',
  ...
  {
    amount: new BigNumber(2.92342e-10),
    blockNumber: 19588945,
    category: 'vtoken',
    createdAt: new Date('2022-05-24T15:25:52.000Z'),
    event: 'Transfer',
    from: '0x2E7222e51c0f6e98610A1543Aa3836E092CDe62c',
    id: 11152,
    timestamp: null,
  ...
  {
    amount: new BigNumber(80.043),
    blockNumber: 19588667,
    category: 'vtoken',
    createdAt: new Date('2022-05-24T15:12:03.000Z'),
    event: 'Redeem',
  ...
  {
    amount: new BigNumber(0.00000236479),
    blockNumber: 19588665,
    category: 'vtoken',
    createdAt: new Date('2022-05-24T15:11:52.000Z'),
    event: 'Transfer',
