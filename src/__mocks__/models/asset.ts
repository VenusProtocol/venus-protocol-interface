...
export const assetData: Asset[] = [
  {
    ...
    treasuryTotalBorrowsUsd: new BigNumber('709257.162839193373613181'),
    treasuryTotalSupplyUsd: new BigNumber('2783115.16880071415163614'),
  ...
  },
  {
    ...
    percentOfLimit: '0',
    hypotheticalLiquidity: ['0', '0', '0'],
    treasuryTotalBorrowsUsd: new BigNumber('8587216575094.36623174884152'),
    treasuryTotalSupplyUsd: new BigNumber('10001838918795063321.399292470565707358'),
  ...
  },
  {
    ...
    percentOfLimit: '0',
    hypotheticalLiquidity: ['0', '0', '0'],
    treasuryTotalBorrowsUsd: new BigNumber('31584447.21332384892254'),
    treasuryTotalSupplyUsd: new BigNumber('1009804120101156879124885.177789655772798633'),
  ...
  },
  {
    ...
    percentOfLimit: '0',
    hypotheticalLiquidity: ['0', '0', '0'],
    treasuryTotalBorrowsUsd: new BigNumber('839103505.021928887132528691'),
    treasuryTotalSupplyUsd: new BigNumber('10547078538.783839597655397544'),
