...
export const assetData: Asset[] = [
  {
    ...
    treasuryTotalBorrowsUsdCents: new BigNumber('70925716.2839193373613181'),
  ...
  },
  {
    ...
    percentOfLimit: '0',
    hypotheticalLiquidity: ['0', '0', '0'],
    treasuryTotalBorrowsUsdCents: new BigNumber('858721657509436.623174884152'),
  ...
  },
  {
    ...
    percentOfLimit: '0',
    hypotheticalLiquidity: ['0', '0', '0'],
    treasuryTotalBorrowsUsdCents: new BigNumber('3158444721.332384892254'),
  ...
  },
  {
    ...
    percentOfLimit: '0',
    hypotheticalLiquidity: ['0', '0', '0'],
    treasuryTotalBorrowsUsdCents: new BigNumber('83910350502.1928887132528691'),
