...
import { IApyChartProps, IInterestRateChartProps } from 'components';

export const fakeApyChartData: IApyChartProps['data'] = [
  {
    apyPercentage: 40,
...
export const fakeInterestRateChartData: IInterestRateChartProps['data'] = [
  {
