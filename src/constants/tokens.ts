...
export const VBEP_TOKENS = isOnTestnet
  ...
  : {
      sxp: {
        id: 'sxp',
        symbol: 'vSXP',
        address: VBEP_TOKEN_ADDRESSES.sxp,
      },
      usdc: {
        id: 'usdc',
        symbol: 'vUSDC',
        address: VBEP_TOKEN_ADDRESSES.usdc,
      },
      usdt: {
        id: 'usdt',
        symbol: 'vUSDT',
        address: VBEP_TOKEN_ADDRESSES.usdt,
      },
      busd: {
        id: 'busd',
        symbol: 'vBUSD',
        address: VBEP_TOKEN_ADDRESSES.busd,
      },
      bnb: {
        id: 'bnb',
        symbol: 'vBNB',
        address: VBEP_TOKEN_ADDRESSES.bnb,
      },
      xvs: {
        id: 'xvs',
        symbol: 'vXVS',
        address: VBEP_TOKEN_ADDRESSES.xvs,
      },
      btcb: {
        id: 'btcb',
        symbol: 'vBTC',
        address: VBEP_TOKEN_ADDRESSES.btcb,
      },
      eth: {
        id: 'eth',
        symbol: 'vETH',
        address: VBEP_TOKEN_ADDRESSES.eth,
      },
      ltc: {
        id: 'ltc',
        symbol: 'vLTC',
        address: VBEP_TOKEN_ADDRESSES.ltc,
      },
      xrp: {
        id: 'xrp',
        symbol: 'vXRP',
        address: VBEP_TOKEN_ADDRESSES.xrp,
      },
      bch: {
        id: 'bch',
        symbol: 'vBCH',
        address: VBEP_TOKEN_ADDRESSES.bch,
      },
      dot: {
        id: 'dot',
        symbol: 'vDOT',
        address: VBEP_TOKEN_ADDRESSES.dot,
      },
      link: {
        id: 'link',
        symbol: 'vLINK',
        address: VBEP_TOKEN_ADDRESSES.link,
      },
      dai: {
        id: 'dai',
        symbol: 'vDAI',
        address: VBEP_TOKEN_ADDRESSES.dai,
      },
      fil: {
        id: 'fil',
        symbol: 'vFIL',
        address: VBEP_TOKEN_ADDRESSES.fil,
      },
      beth: {
        id: 'beth',
        symbol: 'vBETH',
        address: VBEP_TOKEN_ADDRESSES.beth,
      },
      ada: {
        id: 'ada',
        symbol: 'vADA',
        address: VBEP_TOKEN_ADDRESSES.ada,
      },
      doge: {
        id: 'doge',
        symbol: 'vDOGE',
        address: VBEP_TOKEN_ADDRESSES.doge,
      },
      matic: {
        id: 'matic',
        symbol: 'vMATIC',
        address: VBEP_TOKEN_ADDRESSES.matic,
      },
      cake: {
        id: 'cake',
        symbol: 'vCAKE',
        address: VBEP_TOKEN_ADDRESSES.cake,
      },
      aave: {
        id: 'aave',
        symbol: 'vAAVE',
        address: VBEP_TOKEN_ADDRESSES.aave,
      },
      tusd: {
        id: 'tusd',
        symbol: 'vTUSD',
        address: VBEP_TOKEN_ADDRESSES.tusd,
      },
      trx: {
        id: 'trx',
        symbol: 'vTRX',
        address: VBEP_TOKEN_ADDRESSES.trx,
      },
      ust: {
        id: 'ust',
        symbol: 'vUST',
        address: VBEP_TOKEN_ADDRESSES.ust,
      },
      luna: {
        id: 'luna',
        symbol: 'vLUNA',
        address: VBEP_TOKEN_ADDRESSES.luna,
      },
    };
