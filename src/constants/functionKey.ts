enum FunctionKey {
  ...
  GET_VAI_VAULT_PENDING_XVS_WEI = 'GET_VAI_VAULT_PENDING_XVS_WEI',
  GET_VRT_VAULT_INTEREST_RATE_WEI_PER_BLOCK = 'GET_VRT_VAULT_INTEREST_RATE_WEI_PER_BLOCK',
  GET_VRT_VAULT_USER_INFO = 'GET_VRT_VAULT_USER_INFO',
  GET_VRT_VAULT_ACCRUED_INTEREST_WEI = 'GET_VRT_VAULT_ACCRUED_INTEREST_WEI',
  ...
  STAKE_WEI_IN_XVS_VAULT = 'STAKE_WEI_IN_XVS_VAULT',
  STAKE_WEI_IN_VAI_VAULT = 'STAKE_WEI_IN_VAI_VAULT',
  STAKE_WEI_IN_VRT_VAULT = 'STAKE_WEI_IN_VRT_VAULT',
<<<<<<< HEAD
  CAST_VOTE = 'CAST_VOTE',
...
=======
  WITHDRAW_FROM_VAI_VAULT = 'WITHDRAW_FROM_VAI_VAULT',
  WITHDRAW_FROM_VRT_VAULT = 'WITHDRAW_FROM_VRT_VAULT',
>>>>>>> 7a905dfe (add mutation functions to withdraw from VRT and VAI vaults)
}
