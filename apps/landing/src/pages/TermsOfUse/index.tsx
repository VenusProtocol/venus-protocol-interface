...
export const TermsOfUse: React.FC = () => (
  <Legal title="Terms of Use" lastUpdatedAt={new Date(LAST_UPDATED_AT)}>
    ...
    <h2>3. Eligibility and Jurisdiction</h2>
    ...
    <h2>4. User Representation and Warranties</h2>
    ...
    <h2>5. Anti-Money Laundering and Sanctions Compliance</h2>

    <h3>5.1 Prohibited Persons</h3>
    ...
    <h2>7. No Financial, Legal, or Tax Advice</h2>
    ...
    <h2>8. Non-Custodial and Autonomous Nature</h2>
    ...
    <h2>9. Fees and Tax</h2>

    <h3>9.1 Non-Intermediary Status for Blockchain Transactions</h3>
    ...
    <h3>9.2 Limited Transaction Information</h3>
    ...
    <h3>9.3 Blockchain Network Fees and Associated Costs</h3>
    ...
    <h3>9.4 Tax Obligations and Responsibilities</h3>
    ...
    <h2>10. Technology and Protocol Risks</h2>
    ...
    <h3>10.1 Smart Contract Risks</h3>
    ...
    <h3>10.2 Infrastructure Risks</h3>
    ...
    <h3>10.3 Oracle and Price Feed Risks</h3>
    ...
    <h3>10.5 Interoperability Risks</h3>

    <p>Risks arising from interactions with other protocols, bridges, or cross-chain mechanisms.</p>
    ...
    <h2>11. Market, Volatility, and Liquidation Risks</h2>

    <h3>11.1 Market Volatility</h3>
    ...
    <h3>11.2 Liquidation Mechanics</h3>
    ...
    <h3>11.5 Impermanent Loss</h3>

    <p>Certain activities may expose you to impermanent loss or other opportunity costs.</p>
    ...
    <h2>12. Regulatory Uncertainty</h2>
    ...
    <h2>13. No Guarantee of Platform Continuity</h2>
    ...
    <h2>19. Updates and Amendments</h2>
    ...
    <h3>23.2 Mandatory Arbitration</h3>
    ...
    <h3>23.3 Arbitration Venue</h3>

    <p>Hong Kong shall serve as the seat of arbitration proceedings.</p>
    ...
    <h3>23.5 Proceedings Language</h3>

    <p>All arbitration proceedings shall be conducted in the English language.</p>

    <h3>23.6 Arbitrator Authority</h3>
    ...
    <h3>23.7 Survival of Arbitration Provisions</h3>

    <p>These arbitration provisions shall remain in effect following termination of these Terms.</p>

    <h3>23.8 Time Limitations for Claims</h3>
    ...
    <h3>23.9 Notice Requirements</h3>
