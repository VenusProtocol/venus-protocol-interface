...
export const PrivacyPolicy: React.FC = () => (
  <Legal title="Privacy Policy" lastUpdatedAt={new Date(LAST_UPDATED_AT)}>
    ...
    <h2>1. Our Relationship with You</h2>
    ...
    <h3>Connect Using Third-Party Platforms</h3>
    ...
    <h3>Participation in Our Events</h3>
    ...
    <h3>Personal Data collected automatically from you:</h3>
    ...
    <h2>4. International Transfer of Personal Data</h2>
    ...
    <h2>7. What Privacy Rights Do You Have?</h2>
    ...
    <h2>10. Conditions of Use, Notices and Revisions</h2>
