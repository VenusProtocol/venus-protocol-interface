    ...
    fn: ({
      ...
      return {
        ...
        args: [
          ...
          shortVTokenAddress,
          {
            longAmountToRedeemForRepay: repaySwapQuote.fromTokenAmountSoldMantissa,
            minAmountOutRepay: repaySwapQuote.minimumToTokenAmountReceivedMantissa,
            swapDataRepay: repaySwapQuote.callData,
