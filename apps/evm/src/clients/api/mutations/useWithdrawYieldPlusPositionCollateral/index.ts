...
export type WithdrawYieldPlusPositionCollateralInput = {
  longVTokenAddress: Address;
  shortVTokenAddress: Address;
  amountMantissa: bigint;
};

type Options = UseSendTransactionOptions<WithdrawYieldPlusPositionCollateralInput>;

export const useWithdrawYieldPlusPositionCollateral = (options?: Partial<Options>) => {
  ...
  return useSendTransaction({
    fn: ({
      ...
      shortVTokenAddress,
      amountMantissa,
    }: WithdrawYieldPlusPositionCollateralInput) => {
