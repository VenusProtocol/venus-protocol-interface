...
export type IncreaseYieldPlusPositionInput = {
...
type Options = UseSendTransactionOptions<IncreaseYieldPlusPositionInput>;

export const useIncreaseYieldPlusPosition = (options?: Partial<Options>) => {
  ...
  return useSendTransaction({
    fn: ({
      ...
      swapQuote,
    }: IncreaseYieldPlusPositionInput) => {
