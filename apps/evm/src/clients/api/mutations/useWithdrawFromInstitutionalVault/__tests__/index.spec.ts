...
import { useWithdrawFromInstitutionalVault } from '..';
...
describe('useWithdrawFromInstitutionalVault', () => {
  it('calls useSendTransaction with the correct parameters', async () => {
    ...
    renderHook(
      () => useWithdrawFromInstitutionalVault({ vaultAddress: fakeVaultAddress }, fakeOptions),
