...
export type ReduceYieldPlusPositionWithProfitInput = {
...
type Options = UseSendTransactionOptions<ReduceYieldPlusPositionWithProfitInput>;

export const useReduceYieldPlusPositionWithProfit = (options?: Partial<Options>) => {
  ...
  return useSendTransaction({
    fn: ({
      ...
      repaySwapQuote,
      profitSwapQuote,
    }: ReduceYieldPlusPositionWithProfitInput) => {
