...
import {
  type ReduceYieldPlusPositionWithProfitInput,
  useReduceYieldPlusPositionWithProfit,
} from '..';

vi.mock('libs/contracts');

const fakeInput: ReduceYieldPlusPositionWithProfitInput = {
...
describe('useReduceYieldPlusPositionWithProfit', () => {
  it('calls useSendTransaction with correct parameters', async () => {
    renderHook(() => useReduceYieldPlusPositionWithProfit());
