...
describe('useEnterMarket', () => {
  it('calls useSendTransaction with the correct parameters', async () => {
    ...
    renderHook(() => useEnterMarket(fakeOptions), {
    ...
    expect(mockCaptureAnalyticEvent).toHaveBeenCalledWith('Tokens collateralized', {
