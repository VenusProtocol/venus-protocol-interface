...
import { type ReduceYieldPlusPositionWithLossInput, useReduceYieldPlusPositionWithLoss } from '..';

vi.mock('libs/contracts');

const fakeInput: ReduceYieldPlusPositionWithLossInput = {
...
describe('useReduceYieldPlusPositionWithLoss', () => {
  it('calls useSendTransaction with correct parameters', async () => {
    renderHook(() => useReduceYieldPlusPositionWithLoss());
