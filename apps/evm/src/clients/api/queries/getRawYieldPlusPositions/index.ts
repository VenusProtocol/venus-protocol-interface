    ...
    (acc, apiYieldPlusPosition, index) => {
      ...
      const yieldPlusPosition = formatToYieldPlusPosition({
        ...
        averageEntryRatio: apiYieldPlusPosition?.pnl
          ...
          : 0,
        totalShortOpenedMantissa: new BigNumber(
          apiYieldPlusPosition?.pnl?.totalShortOpenedMantissa || 0,
        ),
        totalLongReceivedMantissa: new BigNumber(
          apiYieldPlusPosition?.pnl?.totalLongReceivedMantissa || 0,
        ),
        pool,
      });
