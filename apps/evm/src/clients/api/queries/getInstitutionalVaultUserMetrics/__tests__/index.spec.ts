    ...
    expect(result).toEqual([
      {
        ...
        maxRedeemAmountMantissa: new BigNumber('1000000000000000000'),
        maxWithdrawAmountMantissa: new BigNumber('1500000000000000000'),
      },
      {
        vaultAddress: fakeVaultAddresses[1],
        maxRedeemAmountMantissa: new BigNumber('2500000000000000000'),
        maxWithdrawAmountMantissa: new BigNumber('3000000000000000000'),
      },
    ]);
  });
