...
export const PRIME_DOC_URL = `${VENUS_DOC_URL}/whats-new/prime-yield`;

export const DISCORD_SERVER_URL = 'https://discord.com/servers/venus-protocol-912811548651708448';
export const COMMUNITY_URL = 'https://community.venus.io/';
...
export const VENUS_PRIVACY_POLICY_URL = 'https://venus.io/privacy-policy';
export const VENUS_TERMS_OF_USE_URL = 'https://venus.io/terms-of-use';
