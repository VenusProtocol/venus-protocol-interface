enum FunctionKey {
  ...
  WRAP_TOKENS_AND_SUPPLY = 'WRAP_TOKENS_AND_SUPPLY',
  WRAP_TOKENS_AND_REPAY = 'WRAP_TOKENS_AND_REPAY',
  UPDATE_POOL_DELEGATE_STATUS = 'UPDATE_POOL_DELEGATE_STATUS',
  BORROW_AND_UNWRAP = 'BORROW_AND_UNWRAP',
  REDEEM_AND_UNWRAP = 'REDEEM_AND_UNWRAP',
  REDEEM_UNDERLYING_AND_UNWRAP = 'REDEEM_UNDERLYING_AND_UNWRAP',
}
