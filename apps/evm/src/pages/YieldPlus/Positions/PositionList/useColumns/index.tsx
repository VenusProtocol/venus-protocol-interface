...
export const useColumns = ({
  ...
  const columns: TableColumn<YieldPlusPosition>[] = [
    ...
    },
    {
      ...
      sortRows: (rowA, rowB, direction) =>
        compareBigNumbers(rowA.averageEntryPriceTokens, rowB.averageEntryPriceTokens, direction),
      align: 'right',
      renderCell: ({ shortAsset, averageEntryPriceTokens }) => (
        <LayeredValues
          className="whitespace-nowrap"
          topValue={formatTokensToReadableValue({
            value: averageEntryPriceTokens,
            token: shortAsset.vToken.underlyingToken,
            addSymbol: false,
          })}
        />
