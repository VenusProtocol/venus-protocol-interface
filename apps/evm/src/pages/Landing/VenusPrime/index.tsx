...
export const VenusPrime: React.FC = () => {
  ...
  return (
    <div className={cn('mt-15 md:mt-20 xl:mt-25')}>
      <div className={cn('relative overflow-hidden flex h-112.5 sm:h-87.5 md:h-100 rounded-lg')}>
        <div className="absolute top-0 bottom-0 start-0 end-0">
          <img
            loading="lazy"
            className={cn('absolute max-w-full h-full object-cover', 'object-[30%_50%]')}
            src={venuePrimeBg}
            role="img"
        ...
        <div
          className={cn(
            'relative flex flex-col w-full p-6 z-10',
