import { useGetMarketsAndTvl } from 'clients/api/queries/getMarketsAndTvl/useGetMarketsAndTvl';
import { nFormatter } from 'clients/api/queries/getMarketsAndTvl/utils';
    ...
    <Container className={cn(s.root, className)}>
      ...
      {isLoading ? (
        ...
        <div className={s.marketsWrapper}>
          ...
          <Link href={DAPP_URL} variant="text" className="mx-auto h-auto flex py-7">
            All markets
          </Link>
        </div>
      )}
