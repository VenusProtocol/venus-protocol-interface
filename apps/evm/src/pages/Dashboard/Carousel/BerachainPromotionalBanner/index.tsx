...
export const BerachainPromotionalBanner: React.FC = () => {
  ...
  return (
    <Template className="berachain-theme border-blue bg-gradient-to-t from-[#08080A] to-[#AD6501] to-[200%] sm:from-[#AD6501] sm:to-[#08080A] sm:to-[100%] sm:from-[-100%] flex-col p-0 sm:flex sm:flex-row sm:p-0 md:justify-between">
      <img
