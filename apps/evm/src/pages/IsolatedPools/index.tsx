...
export const IsolatedPools: React.FC = () => {
  ...
  useEffect(() => {
    if (!selectedPoolComptrollerAddress && !isGetPoolsLoading) {
      setSearchParams(currentSearchParams => ({
        ...Object.fromEntries(currentSearchParams),
        [POOL_COMPTROLLER_ADDRESS_PARAM_KEY]: pools[0].comptrollerAddress,
      }));
    }
  }, [selectedPoolComptrollerAddress, isGetPoolsLoading, pools, setSearchParams]);
  ...
  if (!isGetPoolsLoading && pools.length < 2) {
