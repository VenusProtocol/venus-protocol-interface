...
describe('WithdrawForm', () => {
  ...
  it('prompts user to acknowledge risk if requested borrow lowers health factor to risky threshold', async () => {
    ...
    const inputValue = fakePool
      .userBorrowLimitCents!.minus(
        fakePool.userBorrowBalanceCents!.multipliedBy(HEALTH_FACTOR_MODERATE_THRESHOLD - 0.01),
      )
      .dividedBy(fakeAsset.collateralFactor)
      .dividedBy(fakeAsset.tokenPriceCents)
      .toFixed(fakeAsset.vToken.underlyingToken.decimals);
