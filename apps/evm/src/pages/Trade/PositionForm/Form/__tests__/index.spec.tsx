...
import { calculateMaxLeverageFactor } from 'pages/Trade/calculateMaxLeverageFactor';
...
describe('Trade PositionForm Form', () => {
  ...
  it('renders the open form with the real inputs and leverage control', async () => {
    ...
    expect(screen.getByText(en.trade.operationForm.openForm.dsaFieldLabel)).toBeInTheDocument();
    expect(screen.getByText(en.trade.operationForm.openForm.longFieldLabel)).toBeInTheDocument();
    expect(screen.getByText(en.trade.operationForm.openForm.shortFieldLabel)).toBeInTheDocument();
    expect(
