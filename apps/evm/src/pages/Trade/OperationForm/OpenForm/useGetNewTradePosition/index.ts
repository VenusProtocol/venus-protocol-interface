...
import { areAddressesEqual, formatToTradePosition } from 'utilities';
import { calculateMaxLeverageFactor } from '../../../calculateMaxLeverageFactor';

const DEFAULT_LEVERAGE_FACTOR = 2;

export const useGetNewTradePosition = () => {
  ...
  return {
    ...
    ...otherProps,
    isLoading: otherProps.isLoading || isGetTradeAssetsLoading,
  };
};
