...
describe('WithdrawForm', () => {
  ...
  it('submit button is disabled with no amount', async () => {
    ...
    const submitButton = document.querySelector('button[type="submit"]') as HTMLButtonElement;
    await waitFor(() =>
      expect(submitButton).toHaveTextContent(en.marketForm.submitButtonLabel.enterValidAmount),
    );
  ...
  it('prompts user to acknowledge risk if requested withdrawal lowers health factor to risky threshold', async () => {
    ...
    const submitButton = document.querySelector('button[type="submit"]') as HTMLButtonElement;
    await waitFor(() =>
      expect(submitButton).toHaveTextContent(en.marketForm.submitButtonLabel.withdraw),
    );
    expect(submitButton).toBeDisabled();
