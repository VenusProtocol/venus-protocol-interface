...
import { checkSubmitButtonIsEnabled } from 'containers/MarketForm/__testUtils__/checkFns';
...
describe('RepayWithWalletBalanceForm - Feature flag enabled: wrapUnwrapNativeToken', () => {
  ...
  it('lets user wrap and repay, then calls onClose callback on success', async () => {
    ...
    const submitButton = await waitFor(() => getByText(en.marketForm.submitButtonLabel.repay));
