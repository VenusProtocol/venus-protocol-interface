...
export const MigrateButton: React.FC = () => {
  ...
  const handleMigrate = async () => {
    ...
    const aTokenAmount = 500000000000000000n; // 0.5 aUSDT
    ...
    const instructions = await Promise.all([
      ...
      mcNexus.buildComposable({
        ...
        data: {
          ...
          // }),
          // Make the transaction fail on purpose to test clean up functions
          amount: 0n,
          chainId: chain.id,
          gasLimit: 100000n,
        },
    ...
    const tokenAddresses = [tokenAddress, vTokenAddress, aTokenAddress] as const;
    ...
    const fusionQuote = await meeClient.getFusionQuote({
      ...
      instructions,
      // Transfer back all tokens to EOA. This serves as a fallback in case the transaction fails.
      cleanUps: tokenAddresses.map(address => ({
