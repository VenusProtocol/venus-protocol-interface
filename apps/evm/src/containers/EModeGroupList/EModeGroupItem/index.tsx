...
export interface EModeGroupItemProps {
  pool: Pool;
...
export const EModeGroupItem: React.FC<EModeGroupItemProps> = ({
  eModeGroup,
  pool,
  columns,
  initialOrder,
  ...
  return (
    <div className="@container/eModeGroup">
      {/* Mobile/Tablet view */}
      <EModeGroupCard
      ...
      {/* Desktop view */}
      <Table
        className="hidden @2xl:pt-0 @2xl:block"
        columns={formattedColumns}
        data={eModeGroup.assetSettings}
        rowKeyExtractor={row => row.vToken.address}
        rowOnClick={onEModeAssetSettingsClick}
