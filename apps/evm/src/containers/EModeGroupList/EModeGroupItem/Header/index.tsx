...
export const Header: React.FC<HeaderProps> = ({
  ...
  let buttonLabel = t('eModeGroupList.group.enableButtonLabel');

  if (isEModeGroupEnabled) {
    buttonLabel = t('eModeGroupList.group.disableButtonLabel');
  } else if (pool.userEModeGroup) {
    buttonLabel = t('eModeGroupList.group.switchButtonLabel');
  }
  ...
  if (!isButtonEnabled && !userHasEnoughCollateral) {
    disabledTooltip = isEModeGroupEnabled
      ? t('eModeGroupList.group.cannotDisable.tooltip.notEnoughCollateral')
      : t('eModeGroupList.group.cannotEnable.tooltip.notEnoughCollateral');
        ...
        i18nKey={
          isEModeGroupEnabled
            ? // Translation key: do not remove this comment
              // t('eModeGroupList.group.cannotDisable.tooltip.blockingPositions')
              'eModeGroupList.group.cannotDisable.tooltip.blockingPositions'
            : // Translation key: do not remove this comment
              // t('eModeGroupList.group.cannotEnable.tooltip.blockingPositions')
              'eModeGroupList.group.cannotEnable.tooltip.blockingPositions'
        }
        components={{
          Link: (
            <Button
  ...
  return (
    <>
      <div className={cn('flex flex-col gap-y-4', className)}>
        {!eModeGroup.isActive && (
          <NoticeWarning description={t('eModeGroupList.group.disabledNotice')} />
        )}
