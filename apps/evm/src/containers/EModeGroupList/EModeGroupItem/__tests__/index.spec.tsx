...
import { EModeGroupItem, type EModeGroupItemProps } from '..';
...
const baseProps: EModeGroupItemProps = {
  pool: fakePool,
...
describe('EModeGroupItem', () => {
  ...
  it('lets user enable E-mode group when they meet the criteria', async () => {
    ...
    const { queryAllByText, container } = renderComponent(
      <EModeGroupItem {...baseProps} eModeGroup={fakeEModeGroup} />,
      {
    ...
    const button = queryAllByText(en.eModeGroupList.group.enableButtonLabel)[0].closest('button');
  ...
  it('lets user disable E-mode group when they meet the criteria', async () => {
    ...
    const { queryAllByText, container } = renderComponent(
      <EModeGroupItem {...baseProps} pool={customFakePool} eModeGroup={fakeEModeGroup} />,
      {
        accountAddress: fakeAccountAddress,
      },
    );
    ...
    const button = queryAllByText(en.eModeGroupList.group.disableButtonLabel)[0].closest('button');
  ...
  it('lets user switch E-mode group when they meet the criteria', async () => {
    ...
    const button = queryAllByText(en.eModeGroupList.group.switchButtonLabel)[0].closest('button');
  ...
  describe.each([
    ['enable', undefined, fakePool.eModeGroups[0], en.eModeGroupList.group.enableButtonLabel],
    [
      'switch',
      fakePool.eModeGroups[0],
      fakePool.eModeGroups[1],
      en.eModeGroupList.group.switchButtonLabel,
    ],
