...
export const useColumns = () => {
  ...
  const columns: TableColumn<EModeAssetSettings>[] = [
    ...
    {
      key: 'collateral',
      label: t('eModeGroupList.table.columns.collateral'),
      selectOptionLabel: t('eModeGroupList.table.columns.collateral'),
    ...
    {
      key: 'isBorrowable',
      label: t('eModeGroupList.table.columns.isBorrowable'),
      selectOptionLabel: t('eModeGroupList.table.columns.isBorrowable'),
    ...
    {
      key: 'maxLtv',
      label: t('eModeGroupList.table.columns.maxLtv'),
      selectOptionLabel: t('eModeGroupList.table.columns.maxLtv'),
    ...
    },
    {
      ...
      label: t('eModeGroupList.table.columns.liquidationThreshold'),
      selectOptionLabel: t('eModeGroupList.table.columns.liquidationThreshold'),
    ...
    },
    {
      ...
      label: t('eModeGroupList.table.columns.liquidationPenalty'),
      selectOptionLabel: t('eModeGroupList.table.columns.liquidationPenalty'),
