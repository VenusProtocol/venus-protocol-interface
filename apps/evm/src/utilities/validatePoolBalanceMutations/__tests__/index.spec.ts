...
import { type ValidatePoolBalanceMutationsInput, validatePoolBalanceMutations } from '..';
...
interface Case {
  ...
  input: Omit<ValidatePoolBalanceMutationsInput, 't'>;
}
