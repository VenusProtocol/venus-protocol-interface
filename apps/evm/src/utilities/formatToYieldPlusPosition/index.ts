...
export const formatToYieldPlusPosition = ({
  ...
  averageEntryRatio,
  totalShortOpenedMantissa,
  totalLongReceivedMantissa,
}: {
  pool: Pool;
  chainId: ChainId;
  ...
  totalShortOpenedMantissa: BigNumber;
  totalLongReceivedMantissa: BigNumber;
}) => {
  ...
  const totalShortOpenedTokens = convertMantissaToTokens({
    value: totalShortOpenedMantissa,
    token: shortAsset.vToken.underlyingToken,
  });
  const totalLongReceivedTokens = convertMantissaToTokens({
    value: totalLongReceivedMantissa,
    // This isn't a typo, the total amount of long tokens received is expressed in short tokens
    token: shortAsset.vToken.underlyingToken,
  });
  ...
  const position: YieldPlusPosition = {
    ...
    totalShortOpenedTokens,
    totalLongReceivedTokens,
    dsaAsset,
    dsaBalanceTokens,
