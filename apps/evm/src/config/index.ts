...
const subgraphUrls = {
  ...
  [ChainId.OPBNB_MAINNET]: {
    ...
    governance: ENV_VARIABLES.VITE_SUBGRAPH_GOVERNANCE_URL_OPBNB_MAINNET,
  },
  [ChainId.ETHEREUM]: {
    markets: ENV_VARIABLES.VITE_SUBGRAPH_MARKETS_URL_ETHEREUM,
    governance: ENV_VARIABLES.VITE_SUBGRAPH_GOVERNANCE_URL_ETHEREUM,
  },
  [ChainId.SEPOLIA]: {
    markets: ENV_VARIABLES.VITE_SUBGRAPH_MARKETS_URL_SEPOLIA,
    governance: ENV_VARIABLES.VITE_SUBGRAPH_GOVERNANCE_URL_SEPOLIA,
  },
  [ChainId.ARBITRUM_ONE]: {
    markets: ENV_VARIABLES.VITE_SUBGRAPH_MARKETS_URL_ARBITRUM_ONE,
    governance: ENV_VARIABLES.VITE_SUBGRAPH_GOVERNANCE_URL_ARBITRUM_ONE,
  },
  [ChainId.ARBITRUM_SEPOLIA]: {
    markets: ENV_VARIABLES.VITE_SUBGRAPH_MARKETS_URL_ARBITRUM_SEPOLIA,
    governance: ENV_VARIABLES.VITE_SUBGRAPH_GOVERNANCE_URL_ARBITRUM_SEPOLIA,
  },
};
