      ...
      vTokens: [
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('3166451056'),
          borrowRatePerBlockOrTimestamp: BN.from('7877402152'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('0'),
          borrowRatePerBlockOrTimestamp: BN.from('1902587519'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('291819614'),
          borrowRatePerBlockOrTimestamp: BN.from('3133173952'),
          reserveFactorMantissa: BN.from('100000000000000000'),
      ...
      vTokens: [
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('636663134'),
          borrowRatePerBlockOrTimestamp: BN.from('5081151415'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('181270579'),
          borrowRatePerBlockOrTimestamp: BN.from('3297226775'),
          reserveFactorMantissa: BN.from('250000000000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('1601927693'),
          borrowRatePerBlockOrTimestamp: BN.from('7396632771'),
          reserveFactorMantissa: BN.from('250000000000000000'),
        ...
        },
        {
          ...
          exchangeRateCurrent: BN.from('10000000000000000'),
          supplyRatePerBlockOrTimestamp: BN.from('0'),
          borrowRatePerBlockOrTimestamp: BN.from('2853881278'),
          reserveFactorMantissa: BN.from('100000000000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('971545947'),
          borrowRatePerBlockOrTimestamp: BN.from('4934836431'),
          reserveFactorMantissa: BN.from('100000000000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('2547591516'),
          borrowRatePerBlockOrTimestamp: BN.from('9046467473'),
          reserveFactorMantissa: BN.from('250000000000000000'),
      ...
      vTokens: [
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('1862302840'),
          borrowRatePerBlockOrTimestamp: BN.from('7890137206'),
          reserveFactorMantissa: BN.from('250000000000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('251260309'),
          borrowRatePerBlockOrTimestamp: BN.from('3649235480'),
          reserveFactorMantissa: BN.from('250000000000000000'),
        ...
        },
        {
          ...
          exchangeRateCurrent: BN.from('10000000000000000'),
          supplyRatePerBlockOrTimestamp: BN.from('300884001'),
          borrowRatePerBlockOrTimestamp: BN.from('3710902682'),
          reserveFactorMantissa: BN.from('100000000000000000'),
          supplyCaps: BN.from('18600000000000'),
          borrowCaps: BN.from('14880000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('1917107601'),
          borrowRatePerBlockOrTimestamp: BN.from('6149212762'),
          reserveFactorMantissa: BN.from('100000000000000000'),
          supplyCaps: BN.from('2000000000000000000000000'),
          borrowCaps: BN.from('1600000000000000000000000'),
      ...
      vTokens: [
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('2252321478'),
          borrowRatePerBlockOrTimestamp: BN.from('8569789430'),
          reserveFactorMantissa: BN.from('250000000000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('2707330762'),
          borrowRatePerBlockOrTimestamp: BN.from('9293000783'),
          reserveFactorMantissa: BN.from('250000000000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('123416976'),
          borrowRatePerBlockOrTimestamp: BN.from('2960219131'),
          reserveFactorMantissa: BN.from('250000000000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('2061136728'),
          borrowRatePerBlockOrTimestamp: BN.from('8244546350'),
          reserveFactorMantissa: BN.from('250000000000000000'),
        ...
        },
        {
          ...
          supplyRatePerBlockOrTimestamp: BN.from('1779965752'),
          borrowRatePerBlockOrTimestamp: BN.from('5993150684'),
          reserveFactorMantissa: BN.from('100000000000000000'),
          supplyCaps: BN.from('2000000000000000000000000'),
          borrowCaps: BN.from('1600000000000000000000000'),
