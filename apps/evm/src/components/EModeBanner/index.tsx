...
export const EModeBanner: React.FC<EModeBannerProps> = ({
  ...
  return (
    <div
      className={cn(
        'rounded-lg bg-linear-to-l from-[#071F39] to-[#1549A1] relative flex items-center before:content-[""] before:absolute before:inset-0 before:bg-[url("/images/noise.png")] before:bg-repeat before:mix-blend-soft-light overflow-hidden sm:pr-3',
