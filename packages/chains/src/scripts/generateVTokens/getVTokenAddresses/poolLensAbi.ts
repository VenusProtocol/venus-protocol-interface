    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'minLiquidatableCollateral', type: 'uint256' },
          {
            components: [
    ...
    outputs: [
      {
        components: [
          { internalType: 'address', name: 'vToken', type: 'address' },
          { internalType: 'uint256', name: 'exchangeRateCurrent', type: 'uint256' },
          { internalType: 'uint256', name: 'supplyRatePerBlockOrTimestamp', type: 'uint256' },
          { internalType: 'uint256', name: 'borrowRatePerBlockOrTimestamp', type: 'uint256' },
          { internalType: 'uint256', name: 'reserveFactorMantissa', type: 'uint256' },
          { internalType: 'uint256', name: 'supplyCaps', type: 'uint256' },
          { internalType: 'uint256', name: 'borrowCaps', type: 'uint256' },
          { internalType: 'uint256', name: 'totalBorrows', type: 'uint256' },
