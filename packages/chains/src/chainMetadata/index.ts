import chainIconUrls from '../generated/chainIconUrls.json';
import { bnb, eth } from '../tokenMetadata/nativeTokens';
...
export const chainMetadata: {
  ...
  [ChainId.ARBITRUM_ONE]: {
    name: 'Arbitrum One',
    logoSrc: chainIconUrls.arbitrumOne,
  ...
  [ChainId.OPTIMISM_MAINNET]: {
    name: 'Optimism',
    logoSrc: chainIconUrls.optimism,
  ...
  [ChainId.UNICHAIN_MAINNET]: {
    name: 'Unichain',
    logoSrc: chainIconUrls.unichain,
